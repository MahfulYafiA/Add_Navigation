...
fun CheckoutScreen(
    ...
    Column(
        ...
        OrderSubCost(
            ...
            price = formatPrice(orderUiState.itemTotalPrice),
        ...
        OrderSubCost(
            ...
            price = formatPrice(orderUiState.orderTax),
            Modifier.align(Alignment.End)
        )

        // Total
        Text(
            text = stringResource(R.string.total, formatPrice(orderUiState.orderTotalPrice)),
